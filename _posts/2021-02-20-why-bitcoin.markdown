...
Finally, apart from Bitcoin, there are many other revolutionary innovations that have been possible thanks to blockchain technology that are not necessarily related to monetary transaction which I would like to touch upon at some point.